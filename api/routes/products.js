...
router.get('/api/v1/users/requests', (req, res) => { // Fetching all requests
  res.send(requests);
});

router.get('/api/v1/users/requests/:ID', (req, res) => { // Fetching a particular request
  if (req.params.ID) {
...
router.post('/api/v1/users/requests', (req, res) => { // Adding a request
...
router.put('/api/v1/users/requests/:ID', (req, res) => { // Modifying  a request
  const number = req.params.ID;
...
router.delete('/api/v1/users/requests/delete/:userID', (req, res) => { // Modifying  a request
